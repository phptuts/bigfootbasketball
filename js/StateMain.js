...
var StateMain={    
   ...
   preload:function()
    ...
    create:function()
    {
        ...
        game.physics.enable([bigFootSprite, basketball], Phaser.Physics.ARCADE);
        ...
        hoop = game.add.sprite(50, 120, 'hoop');
    ...
    controls: function() 
    {
        ...
        if (spaceKey.downDuration(4000)) {
            shootingBall = true;
            basketball.body.velocity.x = -300;
            basketball.body.gravity.y = 400;
            basketball.body.velocity.y = -600;
        }
